...
from nerfstudio.criticalpixel.camera.camera import Camera, create_camera_from_dict, CameraModel
from nerfstudio.criticalpixel.camera import FoVCamera
...
for cam_name, cam_json in camera_dict.items():
    ...
    if cam.model != CameraModel.Panoramic and cam.model != CameraModel.Fisheye:
