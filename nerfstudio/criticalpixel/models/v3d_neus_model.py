...
from nerfstudio.v3d.core.model_components.ray_sampler import NeuSHierarchicalSamplerConfig
from nerfstudio.v3d.core.models.v3d_base_model import (V3dBaseModel,
                                                       V3dModelConfig)


@dataclass
class V3dNeusModelConfig(V3dModelConfig):
    _target: Type = dataclasses.field(default_factory=lambda: V3dNeusModel)
    ...
    sampler: NeuSHierarchicalSamplerConfig = NeuSHierarchicalSamplerConfig(
...
class V3dNeusModel(V3dBaseModel):
    
    config: V3dNeusModelConfig
