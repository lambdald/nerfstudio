...
nerf_descriptions = {
    "colmap-nerfacto": "nerf model for render",
}

nerf_method_configs["colmap-nerfacto"] = TrainerConfig(
    method_name="colmap-nerfacto",
    steps_per_save=5000,
    ...
    pipeline=NeRFPipelineConfig(
        ...
        model=NerfactoModelConfig(
            ...
            sampler=ProposalSamplerConfig(
                ...
                proposal_nets=[
                    NerfFieldConfig(
                        use_spatial_distortion=False,
                        spatial_distortion_bound=1.1,
