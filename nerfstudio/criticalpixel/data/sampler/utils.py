...
def dilate(tensor: torch.Tensor, kernel_size=3) -> torch.Tensor:
...
def erode(tensor: torch.Tensor, kernel_size=3) -> torch.Tensor:
...
def erode_mask(tensor: torch.Tensor, pixel_radius: int = 1):
